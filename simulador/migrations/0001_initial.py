# Generated by Django 5.2 on 2025-05-25 05:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('te', models.FloatField(default=0.3, validators=[simulador.validators.validar_positivo], verbose_name='Tarifa TE (R$)')),
                ('tusd', models.FloatField(default=0.4, validators=[simulador.validators.validar_positivo], verbose_name='Tarifa TUSD (R$)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('irradiancia', models.FloatField(verbose_name='Índice de Irradiância (kWh/m²/mês)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conta_luz', models.FloatField(default=0, validators=[simulador.validators.validar_positivo], verbose_name='Valor da Conta de Luz (R$)')),
